...
try:
    ...
    #contatos_utils.contatos_para_json(contatos, 'trabalhando-com-io/dados/contatos.json')
    contatos = contatos_utils.json_para_contatos('trabalhando-com-io/dados/contatos.json')
